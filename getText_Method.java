...
public class getText_Method {
	...
	public static void main(String[] args) {
		...
		passwordvariable.sendKeys("xxxx");
		
		driverobject.findElement(By.xpath("//button[@type='submit']")).submit();
		
		WebElement Errormessagevariable=driverobject.findElement(By.xpath("//span[contains(text(),'Invalid credentials')]"));
		
		System.out.println(Errormessagevariable.getText());
		
		if (Errormessagevariable.getText().equals("Invalid credentials")){
